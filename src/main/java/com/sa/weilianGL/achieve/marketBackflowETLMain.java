 ...
 * 获取新注册用户数
 */
public class marketBackflowETLMain {

    public static String marketBackflowmain(String toDate) {
...
//        HashMap<String, String> allmap =
         result = welETLMarket.marketBackflowETL(toDate,toDate,profilesDate,result);
...
//        }
        ...
        if(now >= new1now){
            ...
            result = welETLMarket.marketBackflowETL(toDate,toDateNew1,profilesDate,result);
        }
        ...
        if(now >= new3now){
            ...
            result = welETLMarket.marketBackflowETL(toDate,toDateNew3,profilesDate,result);
        }
        ...
        if(now >= new5now){
            ...
            result = welETLMarket.marketBackflowETL(toDate,toDateNew5,profilesDate,result);
        }
        ...
        if(now >= new7now){
            ...
            result = welETLMarket.marketBackflowETL(toDate,toDateNew7,profilesDate,result);
        }
        ...
        if(now >= new14now){
            ...
            result = welETLMarket.marketBackflowETL(toDate,toDateNew14,profilesDate,result);
        }
        ...
        if(now >= new30now){
            ...
            result = welETLMarket.marketBackflowETL(toDate,toDateNew30,profilesDate,result);
        }
...
//         * sink - 输出csv
//         */
//        CSVUtil.createMbCSVFile(result,outPutPath,"应用市场回流");

 ...
 * 获取激活用户数
 */
public class activateETLMain {

    public static HashMap activatemain(String toDate) {
         ...
         * 1、获取激活用户数
         */
        HashMap<String, String> allmap = welETL.activations(toDate,profilesDate);
        ...
        if(now >= newnow){
            welETL.activationsETL(toDate,toDate,profilesDate,allmap);
        }
        ...
        if(now >= new1now){
            ...
            welETL.activationsETL(toDate,toDateNew1,profilesDate,allmap);
        }
        ...
        if(now >= new3now){
            ...
            welETL.activationsETL(toDate,toDateNew3,profilesDate,allmap);
        }
        ...
        if(now >= new5now){
            ...
            welETL.activationsETL(toDate,toDateNew5,profilesDate,allmap);
        }
        ...
        if(now >= new7now){
            ...
            welETL.activationsETL(toDate,toDateNew7,profilesDate,allmap);
        }
        ...
        if(now >= new14now){
            ...
            welETL.activationsETL(toDate,toDateNew14,profilesDate,allmap);
        }
        ...
        if(now >= new30now){
            ...
            welETL.activationsETL(toDate,toDateNew30,profilesDate,allmap);
        }
        //重新遍历

 ...
 * 获取新注册用户数
 */
public class marketActivateETLMain {

    public static String marketActovatemain(String toDate) {
...
//        }
        ...
        if(now >= new1now){
            ...
            result = welETLMarket.marketActivationsETL(toDate,toDateNew1,profilesDate,result);
        }
        ...
        if(now >= new3now){
            ...
            result = welETLMarket.marketActivationsETL(toDate,toDateNew3,profilesDate,result);
        }
        ...
        if(now >= new5now){
            ...
            result = welETLMarket.marketActivationsETL(toDate,toDateNew5,profilesDate,result);
        }
        ...
        if(now >= new7now){
            ...
            result = welETLMarket.marketActivationsETL(toDate,toDateNew7,profilesDate,result);
        }
        ...
        if(now >= new14now){
            ...
            result = welETLMarket.marketActivationsETL(toDate,toDateNew14,profilesDate,result);
        }
        ...
        if(now >= new30now){
            ...
            result = welETLMarket.marketActivationsETL(toDate,toDateNew30,profilesDate,result);
        }
...
//         * sink - 输出csv
//         */
//        CSVUtil.createMaCSVFile(result,outPutPath,"应用市场激活");
